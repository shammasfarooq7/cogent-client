...
export const projectValidationSchema = yup.object({
  ...
  agreedSla:  yup.array().required('Please select at least one option'),
  coverage:   yup.array().required('Please select at least one option'),
  technologyType: yup.array().required('Please select at least one option'),
  serviceType: yup.array().required('Please select at least one option'),
  supportModel: yup.array().required('Please select at least one option'),
  talentLevel: yup.array().required('Please select at least one option'),
  cancelPolicy: yup.string().required(requiredMessage("Cancel Policy")),
  dispatchAgreed: yup.number().required().positive('Dispatch Agreed must be a positive number'),
  ...
  namedWorker: yup.boolean().required(requiredMessage("Named Worker")),
...
export const JobsValidationSchema = yup.object({
  ...
  sat: yup.boolean().required(requiredMessage("Sat")),
  sun: yup.boolean().required(requiredMessage("Sun")),
  siteTiming: yup.string().required(requiredMessage("Site Timing")),
  timeZone: yup.string().required(requiredMessage("Time Zone")),
  dispatchAgreed: yup.number().required().positive('Dispatch Agreed must be a positive number'),
  incrementTime: yup.string().required(requiredMessage("Increment Time")),
  serviceType:  yup.array().required('Please select at least one option'),
  supportType:  yup.array().required('Please select at least one option'),
  serviceCatItem:  yup.array().required('Please select at least one option'),
  agreedSla:  yup.array().required('Please select at least one option'),
  coverage: yup.array().required('Please select at least one option'),
  technologyType:  yup.array().required('Please select at least one option'),
  currency:  yup.array().required('Please select at least one option'),
