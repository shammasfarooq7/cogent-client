...
export const AccountTable = ({ tableName, buttonText, search, setTicketTabelRefetch, ticketTableRefetch, todays=false}) => {
    ...
    return (
        <>
            ...
            {openSDForm && <AccountForm openModal={openSDForm} setOpenModal={setOpenSDForm} editInfo={editInfo} refetchResources={refetch} />}
