...
import { getUrlNameforDwnload } from '../../helper';
...
export const ResourceOpportunity = () => {
        ...
        <Box  sx={{ mb: 2, display:'flex', justifyContent:'space-between' }}>
          ...
          <Box>
            ...
            <Button onClick={handleUpdateClick}
             sx={{mr:'10px', backgroundColor:'#00A3FF', color:'white',textTransform:'capitalize', '&:hover': {
                backgroundColor: '#00A3FF'
              }}} >
                Apply</Button>
          <Button  sx={{mr:'10px', backgroundColor:'#50CD89', color:'white', textTransform:'capitalize','&:hover': {
