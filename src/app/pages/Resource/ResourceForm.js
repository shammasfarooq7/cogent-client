...
export const ResourceForm = ({ openModal, setOpenModal, editInfo, refetchTickets, type }) => {
                ...
                <Box sx={style}>
                    <Box sx={{ display: "flex" }}>
                        <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ padding: "12px", fontFamily: "popins", fontWeight: "600" }}>
                             {type === "Oportunity" ? "Apply for the Position" : "Check In/Out"}
                        </Typography>
                                    ...
                                    <Grid container spacing={2} >
                                        ...
                                        <CustomDocumentUploadController
                                            ...
                                            <CustomFormController
                                                controllerName='checkIn'
                                                controllerLabel='Check In'
                                                fieldType='text'
