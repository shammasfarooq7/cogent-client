...
export const CustomerFseTicket = () => {
        ...
        <Box  sx={{ mb: 2, display:'flex', justifyContent:'space-between' }}>
          <Box sx={{ display: "flex", flexDirection: "row" }}>
            <Box sx={{ paddingLeft: "5px" }}>
              <Typography sx={{fontWeight: 'bold'}}> Work Order# {getName(info?.id)} </Typography>
            </Box>
          </Box>
          <Box>
            <Box sx={{ display: "flex", flexDirection: "row" }}>
          <Button  sx={{mr:'10px', backgroundColor:'#333333', color:'white', textTransform:'capitalize', '&:hover': {
                backgroundColor: '#333333'
              }}} onClick={handleUpdateClick} >Edit</Button>
            <Button 
             sx={{mr:'10px', backgroundColor:'#EFEFEF', color:'#333333',textTransform:'capitalize'}} >Delete</Button>
            </Box>
          </Box>
        </Box>
        {/* <Divider /> */}
