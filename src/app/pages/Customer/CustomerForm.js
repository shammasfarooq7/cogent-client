...
export const CustomerForm = ({ openModal, setOpenModal, editInfo, refetchTickets }) => {
    ...
    return (
                                    ...
                                    <Grid container spacing={2} >
                                        ...
                                        <Grid item xs={6}>
                                            <CustomFormController
                                                controllerName='ticketReceivedTime'
                                        ...
                                        <Grid item xs={6}>
                                            <CustomFormController
                                                controllerName='ticketReceivedDate'
      ...
      <HeaderResource heading="SERVICE DETAILS" />
                                ...
                                <HeaderResource heading="Appointement Calendar" />
                                <Grid container spacing={2}>

                                    <Grid item xs={12}>
                                        <CustomDropDrownController
                                            controllerName='scheduleFarLater'
                                            controllerLabel='Schedule Far Later'
                                            fieldType='text'
                                            currencies={regions}                       
                                        />
                                    </Grid>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12}>
                                        <CustomDocumentUploadController
                                            controllerName='uploadAttachment'
                                            controllerLabel='Upload Attachment'
                                            fieldIcon={<AttachFileIcon>
                                                <input type="file" />
                                            </AttachFileIcon>}
                                        />                
