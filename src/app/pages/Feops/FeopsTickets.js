    ...
    <Container maxWidth="100%" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box sx={{ backgroundColor: "white", p: 1.5, border:2, borderColor: getBorderColour(info?.status)}}>
        ...
        <Grid container sx={{ mb: 2 }}>
          ...
          <Button  sx={{mr:'10px', backgroundColor:'#50CD89', color:'white'}} >Assign Resource</Button>
            <Button  sx={{mr:'10px', backgroundColor:'#00A3FF', color:'white'}} >Chat</Button>
            <Button  sx={{ color: "white", backgroundColor: "#333333", marginRight: "10px" }} onClick={handleUpdateClick}>Edit</Button>
