...
export const ResourceForm = ({openModal , setOpenModal}) => {
    ...
    const methods = useForm({
      ...
      const onSubmit = async (data) => {
        const { status , engagementType , languages , skillSet , availableTools , beneficiaryFirstName , beneficiaryMiddleName , beneficiaryLastName , beneficiaryAddress , accountNumber , swiftCode , iban , bankAddress, bankName , branchName , isOnboarded} = data
          ...
          <Box sx={style}>
           ...
           <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid item xs={6}>
             ...
             <Grid item xs={6}>
             <CustomFormController 
                 controllerName='accountTittle'
                 controllerLabel='Account Tittle'
                 fieldType='text'
             />
             </Grid>
             <Grid item xs={4}>
